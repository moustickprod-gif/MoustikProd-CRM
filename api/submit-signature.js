...
export default async function handler(req, res) {
  ...
  try {
    ...
    const lienSign = `https://moustikprod-crm.vercel.app/sign.html?token=${token}`;
      ...
      const emailHtml = `
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;border:1px solid #eee;border-radius:8px;overflow:hidden">
          ...
          <div style="padding:30px">
            ...
            <p>Votre <strong>${type === 'devis' ? 'bon de commande' : 'contrat'}</strong>${titre ? ' pour le projet <strong>' + titre + '</strong>' : ''} a bien été signé par les deux parties.</p>
